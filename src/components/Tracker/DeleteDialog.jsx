  ...
  return (
    ...
    >
      ...
      <div className={styles.dialogActions}>
        <button onClick={onClose} className={styles.cancelBtn} title='Cancel habit'>Cancel</button>
        <button className={styles.deleteBtn} onClick={onConfirm} title='Delete habit'>Delete</button>
      </div>
    </dialog>
  );
};
